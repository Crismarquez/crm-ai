...
from config.config import (
    DISTANCE_EYES_THRESHOLD,
    N_EMBEDDINGS,
    N_EMBEDDINGS_REGISTER,
    logger,
)
...
class Watchful:
    ...
    def quality_criterial(self, face_metadata: Dict) -> bool:
        ...
        right_angle = get_angle(
            face_metadata["kps"][1], face_metadata["kps"][2], face_metadata["kps"][4]
        )

        is_engagement = engagement_detect(
            left_angle=left_angle, right_angle=right_angle, min_angle=80, max_angle=110
        )
